...
# → coding (LiveCodeBench/SWE-bench), 复杂推理与分析 → reasoning (GPQA/AIME),
# 翻译、摘要、格式化 → multilingual+writing. Tune per your own results if needed.
...
TASK_WEIGHTS: dict[str, list[float]] = {
    ...
    "代码审查与调试":       [1.0, 0.3, 0.7, 0.1, 0.1,  0.0,  0.6,  0.2],
    "数据分析与处理":       [0.6, 0.8, 0.8, 0.2, 0.1,  0.0,  0.5,  0.3],
    "文本创作与写作":       [0.1, 0.1, 0.3, 1.0, 0.6,  0.0,  0.5,  0.1],
    "翻译、摘要、格式化":   [0.1, 0.1, 0.2, 0.8, 1.0,  0.0,  0.7,  0.1],
    "复杂推理与分析":       [0.4, 0.7, 1.0, 0.3, 0.2,  0.0,  0.6,  0.3],
    "系统架构与设计":       [0.7, 0.4, 1.0, 0.5, 0.2,  0.0,  0.7,  0.5],
    "安全审计与分析":       [0.8, 0.5, 0.9, 0.2, 0.1,  0.0,  0.7,  0.3],
    "性能分析与调优":       [0.8, 0.6, 0.8, 0.2, 0.1,  0.0,  0.6,  0.3],
    # ── 以下两类都偏轻量，但侧重不同 ──
    # 知识问答：重正确性与指令遵循，要答得准、答得全
    "知识问答与学习":       [0.2, 0.4, 0.7, 0.4, 0.4,  0.0,  0.8,  0.2],
    # 日常闲聊：重表达与指令遵循，能力门槛低 → 整体权重压低，利于选便宜模型
    "日常闲聊与简单问答":   [0.1, 0.1, 0.2, 0.6, 0.4,  0.0,  0.5,  0.1],
}
