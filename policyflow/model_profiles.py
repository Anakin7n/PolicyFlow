...
TASK_WEIGHTS: dict[str, list[float]] = {
    ...
    "数学推理":     [0.3, 1.0, 0.8, 0.1, 0.1,  0.0,  0.3,  0.1],
    "逻辑分析":     [0.4, 0.6, 1.0, 0.3, 0.2,  0.0,  0.6,  0.3],
    "文本创作":     [0.1, 0.1, 0.3, 1.0, 0.6,  0.0,  0.5,  0.1],
    "翻译校对":     [0.1, 0.1, 0.2, 0.8, 1.0,  0.0,  0.6,  0.1],
    "图片理解":     [0.2, 0.2, 0.4, 0.3, 0.3,  1.0,  0.4,  0.1],
    "Agent工具调用": [0.5, 0.2, 0.5, 0.2, 0.1,  0.0,  0.8,  1.0],
    "通用问答":     [0.3, 0.3, 0.5, 0.5, 0.4,  0.0,  0.6,  0.2],
    "系统设计":     [0.8, 0.4, 0.9, 0.4, 0.2,  0.0,  0.6,  0.4],
    "安全审计":     [0.7, 0.5, 0.8, 0.2, 0.1,  0.0,  0.6,  0.3],
    "性能优化":     [0.7, 0.6, 0.7, 0.2, 0.1,  0.0,  0.5,  0.2],
}
